...
public sealed class ReflectionDelegateFactoryActivatorTests
{
    //--------------------------------------------------------------------------------
    // Struct
    //--------------------------------------------------------------------------------
    ...
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory(typeof(StructWithConstructor));
    ...
    [Fact]
    public void FactoryTypeWithParameter()
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory(typeof(StructWithConstructor), [typeof(int), typeof(int)]);
    ...
    [Fact]
    public void FactoryTypeWithEmptyParameter()
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory(typeof(StructWithConstructor), Type.EmptyTypes);
    ...
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory(typeof(StructWithConstructor).GetConstructors().First());
    ...
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory2(typeof(StructWithConstructor).GetConstructors().First());
    ...
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory<StructWithConstructor>();
    ...
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory1(typeof(NullableParameterClass).GetConstructors().First());
    ...
    {
        var factory = ReflectionDelegateFactory.Default.CreateFactory<int?, NullableParameterClass>();
